						...
						<div class="inner">
							...
							<?php
										...
										if($username)
										{
												...
												$result = mysqli_query($con, "SELECT M1.picpass, M1.movname, M1.linkpass, M1.date, M1.genr FROM movies M1, users U2  WHERE M1.genr IN (SELECT genr FROM movies M2, users U WHERE U.movid = M2.movid) AND U2.movid <> M1.movid AND U2.username = '$username' ")
