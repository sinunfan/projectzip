...
<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<strong>Movie Entry</strong>									
								</header>

							<!-- Content -->
								<section>
									<header class="main">
										<h1>Use the form below to add movies to the database! double check all entrys!</h1>
									</header>

									<form id="addMovie" method="POST" action="/addMovies.php">
										<div class="row gtr-uniform">
											
											<div class="col-6 col-12-xsmall">
											<label>Title</label>
												<input type="text" maxlength="25" name="title" id="title" value=""/>
											</div>
											<div class="col-6 col-12-xsmall">
											<label>Link</label>
									...
									<?php
										...
										if(isset($_POST['submit'])) 
										{
											...
											$result = mysqli_query($con, "SELECT * FROM movies WHERE movname = '$title' ")
																				or die("\nFailed to query database" .mysqli_error());
																																
											if(mysqli_num_rows($result)==0)			
											{
												
												$stmt = mysqli_query($con, "INSERT INTO movies (picpass, movname, linkpass, date, genr) VALUES ('$picPath', '$title', '$linkPass', '$year','$genre') ");
												echo "Entry Added!";
